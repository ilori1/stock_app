...
$select = $pdo->prepare("SELECT * FROM tbl_user LIMIT 1");
$select->execute();

$row = $select->fetch(PDO::FETCH_ASSOC);

if (!$row) {
    // No user found, display a message and redirect to registration page
    $_SESSION['status'] = "No user found for this app,Register an account as Admin to continue.";
...
if(is_array($row)){
  ...
  if($row['useremail']==$useremail AND $row['userpassword']==$password and $row['role']=="Admin"){
    ...
    $_SESSION['status']="login successfull By Admin";
...
$_SESSION['role'] = $row['role'];
  ...
  elseif($row['useremail']==$useremail AND $row['userpassword']==$password and $row['role']=="User"){
    ...
    $_SESSION['status']="login successfull By User";
    $_SESSION['status_code']="success";
...
<head>
  ...
  <title>NEEMATTECH VENTURE | Log in</title>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="index.php" class="h1"><b>STORE</b> <br>P.O.S</a>
    </div>
    <div class="card-body">
      ...
      <form action="" method="post">
        ...
        <div class="row">
          <div class="col-8">
            ...
            <!-- <a href="ui/changepassword.php">Forgot Password</a> -->
            </div>
          </div>
          <!-- /.col -->
          <div class="col-4">
