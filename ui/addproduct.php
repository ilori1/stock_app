...
if (isset($_POST['btnsave'])){
    ...
    if ($f_extension == 'jpg' || $f_extension == 'jpeg' || $f_extension == 'png' || $f_extension == 'gif') {
        if ($f_size >= 1000000) {
            ...
            $_SESSION['status'] = "Max file shounld be 1MB";
            ...
            if (move_uploaded_file($f_tmp, $store)) {
                ...
                if (empty($barcode)) {
                  ...
                  $insert=$pdo->prepare("insert into tbl_product (product, category, description, stock, purchaseprice, saleprice, image) values(:product, :category, :description, :stock, :purchaseprice, :saleprice, :img)");
                  ...
                  if($update->execute()){
                    ...
                    $insert = $pdo->prepare("insert into tbl_product (barcode, product, category, description, stock, purchaseprice, saleprice, image) values(:barcode, :product, :category, :description, :stock, :purchaseprice, :saleprice, :img)");
        ...
        $_SESSION['status'] = "Only jpg, gif,png files can be uploaded";
        $_SESSION['status_code'] = "warning";
    }
}
?>
