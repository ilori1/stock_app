...
// steps for btn update order button

//1) get values from textfields and from the array in variables

$txt_orderdate    = date('Y-m-d H:i:s');
        ...
        <div class="row">
          ...
          <div class="card card-danger card-outline">
              <div class="card-header">
                <h5 class="m-0"><center>Order Details</center></h5>
              </div>
              <div class="card-body">
...
<div class="col-md-8">
    <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="Scan Barcode" autocomplete="off" name="txtbarcode" id="txtbarcode_id" disabled>
    </div>
    ...
    <form action="" method="post" name="" >
                ...
                <select class="form-control select2" data-dropdown-css-class="select2-purple" style="width: 100%;" disabled>
...
<hr style="height:2px; border-width:0; color:black; background-color:black;">
                ...
                <div class="icheck-success d-inline" disabled>
                        <input type="radio" name="rb" value="Cash" checked id="radioSuccess1"  value="Cash"<?php echo($payment_type=='Cash')?'checked':''?> disabled>
                        <label for="radioSuccess1">
                          CASH
                        </label>
                      </div>
                      <div class="icheck-primary d-inline">
                        <input type="radio" name="rb"  id="radioSuccess2" value="Card"<?php echo($payment_type=='Card')?'checked':''?> disabled>
                        <label for="radioSuccess2">
                          CARD
                        </label>
                      </div> 
                      <div class="icheck-danger d-inline">
                        <input type="radio" name="rb" id="radioSuccess3" value="Check"<?php echo($payment_type=='Check')?'checked':''?> disabled>
...
<div class="input-group">
                ...
                <div class="input-group-prepend">
                  ...
                  <input type="text" class="form-control" name="txtpaid" value="<?php echo $paid;?>" id="txtpaid" readonly>
                  <div class="input-group-append">
                    <span class="input-group-text">NGN</span>
                  </div>
                </div>
      ...
      if (jQuery.inArray(data["product_id"], productarr)!== -1) {
        ...
        function addrow(product_id,product_name,qty,rate,saleprice,stock,barcode) {
          ...
          '<input type="hidden" class="form-control barcode" name="barcode_arr[]" id="barcode_id'+barcode+'" value="'+barcode+'">'+
            ...
            '<td><input type="text" class="form-control qty" name="quantity_arr[]" id="qty_id' + product_id + '" value="'+qty+'" size="1" readonly></td>' +
