...
if (isset($_SESSION['useremail']) && $_SESSION['useremail']!= "") {
  ...
  // No user is logged in, set role to null
  $_SESSION['role'] = null;
  include_once "registrationheader.php";
...
if($delete->execute()){
  ...
  $_SESSION['status']="Unable to delete account";
...
$_SESSION['status']="Email already exists,Use new email";
$_SESSION['status_code']="warning";
